...
os.environ['MALLET_HOME']: str = r'C:\mallet-2.0.8'
working_folder: str =  r"C:\\Users\\phili\\sciebo - Bayerschmidt, Philipp (bayerschmidt@fernuni-hagen.de)@fernuni-hagen.sciebo.de\\Topic Modeling\\Working Group\\wiki\\gz\\wikipack_0\\wikipack_0\\"

stopword_file = os.sep.join(working_folder + "german_stopwords_custome.txt")

source_path: str = "C:\\Users\\phili\\sciebo - Bayerschmidt, Philipp (bayerschmidt@fernuni-hagen.de)@fernuni-hagen.sciebo.de\\Topic Modeling\\Working Group\\wiki\\gz\\wikipack_0\\wikipack_0\\"
...
load_json = False
load_file_name = "OHD_final_100C_95T_a5"
