...
from ohtm.mallet_wrapper.utils_any2vec import (
    _save_word2vec_format,
    _load_word2vec_format,
    ft_ngram_hashes,
)
from ohtm.mallet_wrapper.termsim import TermSimilarityIndex, SparseTermSimilarityMatrix

#
# For backwards compatibility, see https://github.com/RaRe-Technologies/gensim/issues/2201
#
from ohtm.mallet_wrapper.deprecated.keyedvectors import EuclideanKeyedVectors  # noqa
