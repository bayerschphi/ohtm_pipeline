...
def ohtm_pipeline(
        ...
        allowed_postags_settings: list =['NOUN', 'PROPN', 'VERB', 'ADJ', 'NUM', 'ADV'], save_name: str="",load_file_name: str="", mallet_path:str="", interview_id: str = "",
        ...
        infer_new_documents: bool = False, trained_json_name: str = "", save_separate_json:bool = False, separate_json_name: str = ""
):
    ...
    if infer_new_documents == False:
        ...
        if use_preprocessing == True:
            ...
            top_dic = preprocessing(top_dic = top_dic, stoplist_path = stopword_file, allowed_postags_settings=allowed_postags_settings,
                                    by_list=by_list, lemma=lemma, by_particle=by_particle, pos_filter_setting=pos_filter_setting)
    ...
    if infer_new_documents == True:
        ...
        if save_separate_json == True:
            save_json_function(top_dic=infer_dic, working_folder=working_folder, save_name=separate_json_name+"_" + save_name + "_inferred")
    ...
    if search_for_topics_in_interview == True:
        print_chunk_with_interview_weight_search(top_dic=top_dic, interview_id=interview_id, topic_search=topic_search, chunk_weight=chunk_weight)